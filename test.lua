local TimerPool = require('timer').TimerPool
...
pool:update(1500)
assert(pool.size == 0)
assert(pool.clock == 1500)
assert(#pool.priorities == 0)
assert(countkeys(pool.indices) == 0)
assert(#pool.timers == 0)
for i = 1, 1000 do
...
assert(pool.clock == 4000)
assert(#pool.priorities == 1000)
assert(countkeys(pool.indices) == 1000)
assert(#pool.timers == 1000)
